      ...
      <div className="min-h-screen smooth-scroll">
        ...
        <Routes>
          <Route path="/" element={
            <>
              {/* Hero Section */}
              <section className="relative h-screen flex items-center justify-center pt-16 sm:pt-20">
                ...
                <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="max-w-3xl mx-auto text-center text-white">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-6 tracking-tight drop-shadow-lg">
                      Sree Dhanya ARC
                    </h1>
                    <p className="text-lg sm:text-xl md:text-2xl font-light mb-8 sm:mb-10 text-white/90 drop-shadow-lg">
                    ...
                    <button 
                      ...
                      className="bg-white/90 backdrop-blur-sm text-gray-900 px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg font-medium hover:bg-white transition-all duration-300 shadow-lg hover:shadow-xl"
                    >
                      View Arc Homes
                    </button>
                  </div>
              ...
              {/* Gallery Section */}
              <section id="gallery" className="bg-gray-100 py-12 sm:py-16 md:py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="mb-12 sm:mb-16">
                    <h3 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6 sm:mb-8 px-4 sm:px-6">
                      Exterior Views
                    </h3>
                    <GalleryCarousel 
              ...
              <section id="why-arc" className="py-12 sm:py-16 md:py-20 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center text-primary mb-8 sm:mb-12">
